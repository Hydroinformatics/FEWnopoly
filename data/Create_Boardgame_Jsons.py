...
pumping_costs = {'easy': {'100 - 90':{'max': 100, 'min': 90, 'pump_rate': 0},
                     ...
                     'medium': {'100 - 70':{'max': 100, 'min': 70, 'pump_rate': 0},
                     ...
                     'hard': {'100 - 50':{'max': 100, 'min': 50, 'pump_rate': 0},
...
with open('pumping_costs.json', 'w') as fp:
    json.dump(pumping_costs, fp)
